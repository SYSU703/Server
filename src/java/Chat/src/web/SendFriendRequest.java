...
public class SendFriendRequest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("send friend request get method");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		System.out.println("send friend request post method");
		...
		try {
			...
			String receivername = jsonObject.getString("receivername");
			 if (handle.sendFriendRequest (sendername, receivername)) {		
